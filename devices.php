...
<main>
	<h1 class="slideInDown animated opacity_content">Add a new Device/update/remove/Enable/Disable</h1>

	<div class="container py-lg-5 Opacity">
		<!-- devices -->
		<div class="row opacity_content">
