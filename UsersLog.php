...
<head>
  ...
  <?php 
    if(isset($_GET["delete_data_user_log"])) {
      if($_GET["delete_data_user_log"] == "success") {
        ?>
        <div class="up_info2 alert-success ani_opacity" style="display: block;">Delete your user log successful</div>
        <?php
      }
    } 
  ?>
...
<div class="container py-lg-5">
  <!--User table-->
    <h1 class="slideInDown animated opacity_content">Here are the Users daily logs</h1>
    <div class="form-style-5 opacity_content">
      <button type="button" data-toggle="modal" data-target="#Filter-export">Log Filter/ Export to Excel</button>
      <button type="button" data-toggle="modal" data-target="#Delete_data">Delete data user log</button>
    </div>
    <!-- Log filter -->
    <div class="modal fade bd-example-modal-lg" id="Filter-export" tabindex="-1" role="dialog" aria-labelledby="Filter/Export" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        ...
        <!-- Log filter -->
        <div class="modal fade bd-example-modal-lg" id="Delete_data" tabindex="-1" role="dialog" aria-labelledby="Filter/Export" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Delete Your User Log:</h3>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form method="POST" action="delete_data.php" enctype="multipart/form-data">
            <div class="modal-body">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-6 col-sm-6">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint"><b>Delete:</b></label>
                    <input type="submit" name="To_Delete" value="Delete data">
                  </div>
                </div>
              </div>
            </div>
    ...
    <!-- //Log filter -->
    <div class="slideInRight animated opacity_content">
      <div id="userslog"></div>
    </div>
</div>
</main>
